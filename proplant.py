...
# Testing a new image
test_image = cv2.imread('data/Hi.jpg')
...
#%%
#graph plotting for input output name
import tensorflow as tf 
g = tf.GraphDef()
g.ParseFromString(open("D:/Spyder/model_FFF/tf_model.pb", "rb").read())
[n for n in g.node if n.name.find("input") != -1] 
[n for n in g.node if n.name.find("output") != -1] 
#%%
filename='D:/Spyder/model_FFF/tf_model.pb'
